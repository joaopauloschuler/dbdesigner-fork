...
uses
  ...
  Dialogs, StdCtrls, ExtCtrls, CheckLst, ComCtrls, EERModel,

  Buttons, Weboutput, EditorView, FileUtil, DialogDirectorySelect, Layer,
...
begin
  ...
  try
    ...
    if (OutputDirSel.ShowModal = mrOK) then
      ...
      OutputDirEd.Text := IncludeTrailingPathDelimiter(OutputDirSel.DirectoryTreeView.Path);
